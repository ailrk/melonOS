...
void gdt_init() {
    ...
    cpu.gdt[SEG_KCODE] = create_descriptor(0, 0x000fffff, (GDT_CODE_PL0));
    cpu.gdt[SEG_KDATA] = create_descriptor(0, 0x000fffff, (GDT_DATA_PL0));
    cpu.gdt[SEG_UCODE] = create_descriptor(0, 0x000fffff, (GDT_CODE_PL3));
